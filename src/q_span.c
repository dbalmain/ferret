...
static f_u32 spanq_hash(Query *self)
{
...
static Explanation *spanw_explain(Weight *self, IndexReader *ir, int target)
{
    ...
    for (i = 0; i < terms->size; i++) {
        char *term = ((Term *)terms->elems[i])->text;
...
static f_u32 spantq_hash(Query *self)
{
...
static f_u32 spanfq_hash(Query *self)
{
...
static f_u32 spanoq_hash(Query *self)
{
    int i;
    f_u32 hash = spanq_hash(self);
    SpanOrQuery *soq = SpOQ(self);
...
static f_u32 spannq_hash(Query *self)
{
    int i;
    f_u32 hash = spanq_hash(self);
    SpanNearQuery *snq = SpNQ(self);
...
static f_u32 spanxq_hash(Query *self)
{
    SpanNotQuery *sxq = SpXQ(self);
