...
#define Aaiequal(a, b, n)  tst_arr_int_equal(__LINE__, tc, (a), (b), (n))
#define Aasequal(a, b, n)  tst_arr_str_equal(__LINE__, tc, (a), (b), (n))
#define Asnequal(a, b, n)  tst_str_nequal(__LINE__, tc, (a), (b), (n))
