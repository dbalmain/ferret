module Ferret
  module Store
    ...
    # separate file as a separate file on the operating system. This works
    # fine and is the most efficient solution for small to medium size
    # indexes. For very large indexes, there may be a problem with the
    # operating system not wanting to open to many files. One fix for this is
    # to change the maximum open files setting in your operating system.
    # Alternatively you could use a compound file instead.
    # 
    # TODO:
    # * We want to better way of setting properties. Currently you have to
        ...
        private
          ...
          def read_internal(b, offset, length)
            @file.synchronize do
              ...
              b[offset, bytes.length] = bytes.unpack("C*")
            end
          end
